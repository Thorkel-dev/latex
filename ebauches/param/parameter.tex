...
% Ajouter un niveau de sous-sous-paragraphe
...
\setcounter{tocdepth}{6}    % Autoriser l'alinéa dans la table des matières
\setcounter{secnumdepth}{6} % Permettre la numérotation du sous-paragraphe
...
\setminted{
    linenos=true,
    autogobble,
    autogobble=true,         % Aligné avec la marge
