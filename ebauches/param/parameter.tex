...
% Ne fonctionne pas sur toute les distributions Debian
\newcommand{\sectionbreak}{\clearpage}  % Nouvelle page pour chaque section
...
\newcommand\subsubparagraph{%
    ...
    {1em}                                         % avant le titre
    {1em}                                         % après le titre
    {\normalsize\hspace{6em}\color{thorkelBlue}} % style (surcharge par le format du titre)
}
